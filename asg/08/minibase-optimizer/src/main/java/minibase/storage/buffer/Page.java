...
/**
 * Lowest-level view of a disk page. It is parameterized by a phantom type.
 *
...
public final class Page<T extends PageType> {
    ...
    *
    * @param dirty
    *           {@code true} if the page is dirty, {@code false} otherwise
    */
    ...
    *
    * @param pageID
    *           the ID of the represented page
    */
