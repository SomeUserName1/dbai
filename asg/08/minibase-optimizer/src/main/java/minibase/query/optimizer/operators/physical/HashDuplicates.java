/*
 * @(#)HashDuplicates.java   1.0   Jun 28, 2014
 *
...
/**
 * Physical operator that implements the {@link minibase.query.optimizer.operators.logical.Distinct Distinct}
 * logical operator by applying a hash function to all tuple in its input.
 * <p>
 ...
 * @version 1.0
 */
public class HashDuplicates extends AbstractPhysicalOperator {

   /**
    * Creates a new {@code HashDuplicates} physical operator.
    */
   public HashDuplicates() {
      super(OperatorType.HASHDUPLICATES);
   }
   ...
   public Cost getLocalCost(final LogicalProperties localProperties,
      ...
      // TODO Compute I/O cost.
      final double ioCost = 0;
      final double cpuCost = inputCardinality * CostModel.HASH_COST.getCost()
