...
public class QueryExpressionParser/*@bgen(jjtree)*/implements QueryExpressionParserTreeConstants, QueryExpressionParserConstants {/*@bgen(jjtree)*/
  protected JJTQueryExpressionParserState jjtree = new JJTQueryExpressionParserState();
    ...
    *            in the input contains a syntax error
    */
...
if (jjtc000) {
  ...
  final public void GetColumn() throws ParseException {/*@bgen(jjtree) Operator */
   QueryOperator jjtn000 = new QueryOperator(JJTOPERATOR);
   boolean jjtc000 = true;
   jjtree.openNodeScope(jjtn000);QueryColumn column;
    try {
...
if (jjtc000) {
  ...
  final public void Projection() throws ParseException {/*@bgen(jjtree) Operator */
   QueryOperator jjtn000 = new QueryOperator(JJTOPERATOR);
   boolean jjtc000 = true;
   jjtree.openNodeScope(jjtn000);List<QueryColumn> columns;
    try {
...
if (jjtc000) {
  ...
  final public void EquiJoin() throws ParseException {/*@bgen(jjtree) Operator */
   QueryOperator jjtn000 = new QueryOperator(JJTOPERATOR);
   boolean jjtc000 = true;
   jjtree.openNodeScope(jjtn000);List<QueryColumn> leftColumns;
...
if (jjtc000) {
  ...
  final public void OrderBy() throws ParseException {/*@bgen(jjtree) Operator */
   QueryOperator jjtn000 = new QueryOperator(JJTOPERATOR);
   boolean jjtc000 = true;
   jjtree.openNodeScope(jjtn000);List<QuerySortColumn> sortColumns;
    try {
...
if (jjtc000) {
  ...
  final public List<QuerySortColumn> SortColumnList() throws ParseException {QuerySortColumn column;
...
{if ("" != null) return columns;}
  ...
  final public QuerySortColumn SortColumn() throws ParseException {QueryColumn column;
...
{if ("" != null) return new QuerySortColumn(column, order);}
  ...
  final public void GroupByAggregate() throws ParseException {/*@bgen(jjtree) Operator */
   QueryOperator jjtn000 = new QueryOperator(JJTOPERATOR);
   boolean jjtc000 = true;
   jjtree.openNodeScope(jjtn000);List<QueryDerivedColumn> aggregatedColumns;
...
if (jjtc000) {
  ...
  final public List<QueryDerivedColumn> DerivedColumnList() throws ParseException {QueryDerivedColumn column;
...
{if ("" != null) return columns;}
  ...
  final public QueryDerivedColumn DerivedColumn() throws ParseException {List<QueryColumn> inputs;
   String name;
    inputs = ColumnList();
...
{if ("" != null) return new QueryDerivedColumn(name, inputs);}
  ...
  final public List<QueryColumn> GroupBy() throws ParseException {List<QueryColumn> columns;
...
if (jjtc000) {
  ...
  final public List<QueryColumn> ColumnList() throws ParseException {QueryColumn column;
...
{if ("" != null) return columns;}
  ...
  final public QueryColumn Column() throws ParseException {String scope = null;
   String name;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case S_IDENTIFIER:{
      jj_consume_token(S_IDENTIFIER);
